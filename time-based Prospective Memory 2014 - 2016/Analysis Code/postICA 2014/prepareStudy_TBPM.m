clear all; clc; 
ALLEEG = struct();
homeFolder = '/Users/gabycruz/experiments/EEG_timebased_PM/EEGcudaicaTC';
cd(homeFolder)
...
for subj = 1:length(allFolder);
    ...
    EEG = pop_loadset('filename', loadName.name, 'filepath', pwd, 'loadmode', 'info');
    
    EEG.subject = ['Subj' num2str(subj)];
